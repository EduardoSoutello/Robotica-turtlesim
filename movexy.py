...
def move():
        ...
        cima = input("Para frente ou para tras ? ")#True ou False
        sentido = input("Qual o lado deseja andar? 1 = direita 2 = esqueda 3 = frente ")
        ...
        if(sentido == 2):
                ...
                print("Escolha (1) para direita (2) para esquerda e (3) pra frente! ")
